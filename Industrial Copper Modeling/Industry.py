...
icon = Image.open ("C:/Users/User/Desktop/sales.jpg")
st.set_page_config (page_title = "Industrial Copper Modeling",
                    page_icon= icon,
                    layout = "wide",
                    initial_sidebar_state="expanded",
                    menu_items= {'About':"# This  Dashboard App is built using Streamlit"}
...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open("G:/Projects/Industrial Copper Modeling/model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open("G:/Projects/Industrial Copper Modeling/scaler.pkl", 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open("G:/Projects/Industrial Copper Modeling/t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open("G:/Projects/Industrial Copper Modeling/s.pkl", 'rb') as f:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open("G:/Projects/Industrial Copper Modeling/cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open("G:/Projects/Industrial Copper Modeling/cscaler.pkl", 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open("G:/Projects/Industrial Copper Modeling/ct.pkl", 'rb') as f:
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Rex Harrison</h6>', unsafe_allow_html=True ) 